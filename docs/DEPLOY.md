...
- Producción sirve el código del merge `d119b8023a88281183fefcc209d9e09838bdf581` ([PR #2](https://github.com/amariner/logic2b-reserva/pull/2)), versión Cloudflare `09f82d7d-1453-4788-a257-2bc53f3e70cb`, desplegada el 2026-09-18 con autorización expresa del propietario mediante `pnpm deploy`. `pnpm check` 28/28 con 165 tests, E2E final 118/118, dos pases de 42 capturas idénticas y comparación visual 42/42. Dry-runs estrictos con 513 assets; smoke GET/HEAD correcto y 16 archivos públicos idénticos al build validado. No se cambiaron variables habilitadoras de GitHub, secretos ni transporte comercial; no se enviaron leads.
- Preview permanece en el release del 08/09: código `55fe9d6` ([PR #1](https://github.com/amariner/logic2b-reserva/pull/1)), versión `89167b5f-1de0-4efc-8b6d-d7bb024b5ff1`. La versión anterior de producción era `2d099435-9ab2-4f64-89de-1461ee7728bb`.
