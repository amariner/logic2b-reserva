...
- **Qué es:** demo comercial navegable con 3 restaurantes ficticios (Brasca, Vedra, Solane) que escenifican la escalera Inicio → Gestión → Automatiza → Inteligente, más landing de producto con captación de leads real.
...
Lee `CLAUDE.md` (contrato de trabajo) → `SIGUIENTE-SESION.md` (dónde estamos) → `docs/ROADMAP.md` (fases F0–F12 con criterios de hecho). Contexto de mercado en `docs/COMPETENCIA.md`.
