...
- El recorrido de cuatro momentos permite contactar antes del final y mantiene el interés al elegir otro plan. Cuando `sessionStorage` está bloqueado, la URL conserva el contexto y permite recargar o volver atrás. Un enlace con una nueva elección prevalece sobre el recorrido anterior; el origen excluye parámetros privados.
- La solicitud vuelve a la ficha elegida, conserva el plan actualizado en sus CTA y en el cambio de idioma, y deja WhatsApp accesible en móvil. La ficha mantiene su propio interés frente a parámetros contradictorios. Sin JavaScript se ofrece contacto directo sin exponer campos personales en la URL. En `/empezar/` las preferencias de cookies se abren a demanda: no se registra ni presupone consentimiento y no se carga analítica.
- Las nueve webs compartidas priorizan CTA y foto en móvil, diferencian sus cartas y reducen decoración secundaria. El cierre y la puesta en marcha hablan del restaurante con menos texto; contactar es la acción principal y el recorrido queda disponible como opción.
- **Una fotografía nueva generada con OpenAI y cero vídeos nuevos** en esta continuación. Original `apps/site/assets/editorial/preparar-servicio-v1.png`, prompt y procedencia en el README contiguo; derivados AVIF/WebP con tamaños explícitos. Se conservan la fotografía F28 y los medios históricos.
- Regeneradas **48 previews de temas ES/EN**, verificadas contra su manifiesto, digest `98009b690b8f0980dfed4988588700f73c1dd3f311805170a4319385ee8b739b`. Las 24 previews de paneles F28 mantienen sus hashes. Las 42 capturas comerciales históricas no se han regenerado; su actualización sigue pendiente antes de publicar.
- Validación: **`pnpm check` 28/28, 165 tests**, build de **120 HTML** —68 site y 52 web— y auditoría de **4.540 referencias con cero ausencias**. Se han comprobado 108 combinaciones responsive de las nueve webs y revisado visualmente home, foto, solicitud móvil, temas y visor. **118 escenarios E2E verificados**: 115 pasan en el integral de 10 minutos; dos casos de un selector ambiguo y uno que buscaba WhatsApp en su antigua ubicación se corrigen sin cambiar producto y pasan en los cierres dirigidos **14/14 de conversión + 1/1 de inicio comercial** sobre el mismo bundle. No se declara un único pase 118/118.
- Roadmap F29 implementado; F30 prioriza observar dudas reales de propietarios antes de ampliar pantallas, elegir nueva jerarquía del hero o activar medición. Trabajo local en `codex/ux-conversion-2026-09-18`, con el Worker directo Miniflare/workerd y transporte de correo deshabilitado. Sin publicación ni leads reales; no se afirma un aumento de conversión medido.

## 2026-09-18 · F28 · Elegir sin perderse · cerrada en local ✅

- La revisión de los popups y del recorrido de Camp se aplica al producto existente: hero, portfolio y paneles comparten un visor con captura protagonista, una acción contextual, detalle plegable, estados de carga/error y retorno del foco. Las galerías del home incorporan controles visibles y navegación por teclado; las fichas siguen disponibles sin JavaScript.
- El recorrido voluntario se reduce a cuatro momentos —web, reserva, sala y siguiente paso— con copy ES/EN, minimización, salida y vuelta al origen. El estado compartido conserva tema o panel y plan explícito hasta el contacto, mantiene el idioma y resuelve enlaces del recorrido anterior. Se corrige la pérdida de contexto al redirigir un enlace directo a su paso canónico.
- Las nueve webs compartidas distinguen sus composiciones, compactan el móvil y priorizan carta, horario y ubicación. El bloque de reservas identifica la muestra ficticia con brevedad y conserva `?theme=` al elegir diseño. El catálogo reduce repetición, alinea las acciones y mantiene búsqueda y filtros.
- El hero permite continuar sin correo; cuando se introduce, viaja en el fragmento local y se prellena en la solicitud. El formulario único muestra los datos esenciales y despliega teléfono/comentario opcionales sin perder valores al cerrar. No cambia el transporte comercial ni se amplían motores, pagos o integraciones.
- Una fotografía editorial original generada con OpenAI acompaña la solicitud en escritorio, con AVIF/WebP responsive y procedencia en `apps/site/assets/editorial/README.md`. **Una imagen nueva y cero vídeos nuevos**; se conservan los medios históricos.
- Regeneradas **72 previews reales**: 48 de las doce webs y 24 de los seis paneles, en ES/EN y escritorio/móvil. Los 72 archivos coinciden con sus hashes de manifiesto. El nuevo `pnpm fotos:paneles` captura cada slug y vista real; Grupos y eventos abre la propuesta en modo libre conservando el estado solicitado. La comparación entre el primer pase Worker y el final estático coincide en **13/24 hashes**: cuatro capturas cambian por esa preparación y siete móviles por rasterizado. Cada escena final de panel exige dos capturas consecutivas estables; esto no equivale a reproducibilidad byte a byte entre ejecuciones. Las 42 capturas comerciales de `pnpm fotos` no se han regenerado.
- Gate integrado final: **`pnpm check` 28/28, 164 tests** (20 config, 66 dominio, 50 dashboard, 10 fixtures web y 18 Worker). El build compone **120 HTML** —68 site y 52 web—; la auditoría de **4.360 referencias** no encuentra ausencias. Validación dirigida de temas: 108 combinaciones de nueve webs × dos idiomas × seis anchos sin overflow, recortes, imágenes rotas, anclajes ocultos ni targets insuficientes del menú. Seis comprobaciones de filtros y QA visual de composiciones completadas. Revisión adicional del foco al minimizar y de valores de campos plegados, sin enviar formularios. **104 escenarios E2E verificados**: 102 pasan en el integral (10,3 min); dos expectativas antiguas de idioma/copy se actualizan y pasan en el cierre dirigido **19/19** (3,6 min), que también valida los últimos ajustes del popup, contacto, recorrido y todas las páginas públicas a 320/375/430/1366 px. No se declara un único pase 104/104. Worker local directo Miniflare/workerd, mismo bundle y transporte de correo deshabilitado. QA visual final en navegador: contacto compacto a 375 px, preview móvil real sin recorte horizontal, cambio al visor de escritorio y recorrido de cuatro pasos.
- Trabajo local en `codex/ux-conversion-2026-09-18`. No se ha desplegado ni enviado ningún lead real. La entrega reduce fricción de exploración; no se atribuye un aumento de conversión medido.
...
## 2026-09-04 · Sesión 60 · Reconstrucción CAMP-parity completa en local ✅

- La referencia viva de `camp.logic2b.com` se auditó de extremo a extremo y Reserva adopta su misma estructura pública con los recursos, marcas ficticias y textos propios del proyecto. El home conserva el contrato de catorce bloques y recompone cabecera pill, hero, rails, formularios, sliders, previews, cierre y navegación sin importar imágenes, copy ni capacidades de Camp.
- La envolvente comercial es común a las superficies públicas: menú responsive, contacto coherente, formulario modal, prefooter visual y footer estructurado. Los sliders de doce temas y seis paneles abren previews accesibles con contexto, evidencia, límite y enlace profundo; `/temas/`, `/paneles/` y sus fichas bilingües siguen consumiendo los catálogos canónicos del repositorio.
- El recorrido comercial pasa de seis a nueve hitos bilingües y cruza home, catálogo, web Vedra, reserva y vistas reales del gestor. Un bridge entre `apps/site` y `apps/web` conserva el estado en `sessionStorage`, permite pausar, reanudar o salir y mantiene la frontera demostrativa sin nuevas escrituras.
- Los builds estáticos generan 68 páginas de site y 52 de web. QA de navegador y responsive completado sobre 320/375/430/1366 px, con estructura, shell, modal, formularios, previews, recorrido, accesibilidad y fallback sin JavaScript verificados.
- Gates locales finales: `pnpm check` 28/28 con 161 tests y build completo; regresión E2E 85/85 en 9,5 minutos, incluidos todos los recorridos funcionales de las demos y la sincronización entre pestañas. Dos pases completos de `pnpm fotos` coinciden 42/42 con digest agregado `a6ab36c4db011f6601a4b21e96c70322c99d7b04ce2268150c593d12a30e6aaf`; el generador espera la hidratación, valida solo imágenes realmente visibles y evita referencias circulares.
- Release integrado en `origin/main` y publicado en producción como versión `394a6270-735a-4418-851a-d505c2a4bd40`. El dry-run estricto aceptó 368 assets, 566,81 KiB y 85,18 KiB gzip con `DEMO_MODE=true` y D1 cero; el smoke público GET/HEAD quedó verde. El compositor excluye ahora cualquier `.screens-next-*` y la ruta temporal comprobada responde 404. No se envió ningún lead.
