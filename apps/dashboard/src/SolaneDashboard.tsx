...
const COPY = {
  ...
  reservations: {
    ...
    body: text('Las reservas del widget aterrizan con su asignación, depósito proporcional y aceptación temporal de condiciones.', 'Widget bookings land with their assignment, proportional deposit and timestamped acceptance of terms.'),
    ...
    legalTitle: text('Informado antes de reservar · proporcional al perjuicio', 'Disclosed before booking · proportional to the loss'),
    legalBody: text('La demo calcula sobre el precio del menú, conserva la aceptación con fecha y nunca aplica más que el depósito mostrado. No existe ningún cobro real.', 'The demo calculates from the menu price, keeps timestamped acceptance and never applies more than the displayed deposit. No real charge exists.'),
    ...
    charged: text('Cobro proporcional aplicado · demo', 'Proportional charge applied · demo'),
    released: text('Depósito liberado automáticamente', 'Deposit released automatically'),
    markNoShow: text('Marcar no-show y aplicar depósito', 'Mark no-show and apply deposit'),
    seat: text('Sentar y liberar depósito', 'Seat and release deposit'),
    chargedNotice: text('No-show registrado. Se ha aplicado únicamente el depósito proporcional mostrado; no existe cobro real.', 'No-show recorded. Only the displayed proportional deposit was applied; no real charge exists.'),
