...
export const SOLANE_PAGE_COPY = {
  ...
  widget: {
    ...
    deposit: {
      ...
      title: text('Depósito según una regla ficticia', 'Deposit under a fictional rule'),
      ...
      percentage: text('Porcentaje de la regla demo', 'Demo-rule percentage'),
      amount: text('Depósito demo', 'Demo deposit'),
      terms: text('He leído antes de reservar la regla ficticia y el depósito demo mostrado. No se realizará ningún cobro; cualquier política real, importe y aplicación se validaría por proyecto.', 'Before booking, I have read the fictional rule and the demo deposit shown. No charge will be made; any real policy, amount and application would be validated per project.'),
      ...
      gatewayMenu: text('Menú elegido', 'Selected menu'),
      gatewayPolicy: text('Regla ficticia aplicada', 'Fictional rule applied'),
      gatewayAmount: text('Importe simulado', 'Simulated amount'),
      gatewayTerms: text('Condiciones aceptadas antes de continuar', 'Terms accepted before continuing'),
...
const solaneBookings: TableBooking[] = [
  ...
  { id: 'sol-r1', restaurantId: 'solane', tableIds: ['ss1'], slot: { date: DEMO_DATE, startMin: 1200, durationMin: 105 }, partySize: 2, status: 'confirmed', guest: { name: 'Lucía Serra', email: 'lucia@example.test' }, menuId: 'solane-degustacion', source: 'fixture', bookedAt: '2026-08-20T10:30:00.000Z' },
  { id: 'sol-r2', restaurantId: 'solane', tableIds: ['ss2'], slot: { date: DEMO_DATE, startMin: 1215, durationMin: 105 }, partySize: 4, status: 'pending', guest: { name: 'Marc Vidal', phone: '+34 600 000 002' }, menuId: 'solane-degustacion', source: 'phone', bookedAt: '2026-09-17T18:10:00.000Z' },
